...
qa_file_path = f"qa-{chunk_s}-2.json"
success_txt_path = f"success-files-qa-{chunk_s}-2.txt"
success_total_nodes_txt_path = f"success-total-node-details-qa-{chunk_s}-2.txt"
error_file_path = f"errors-qa-{chunk_s}-2.json"
